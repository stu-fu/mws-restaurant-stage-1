 ...
 */fillRestaurantHTML=(restaurant=self.restaurant)=>{const restaurantContainer=document.getElementById('restaurant-container');const restaurantHeading=document.createElement('h1');restaurantHeading.setAttribute('id','restaurant-name');restaurantHeading.className='restaurant-name';restaurantHeading.innerHTML=restaurant.name;const restaurantAddress=document.createElement('p');restaurantAddress.setAttribute('id','restaurant-address');restaurantAddress.className='restaurant-address';restaurantAddress.innerHTML=restaurant.address;const restaurantImage=document.createElement('img');restaurantImage.setAttribute('id','restaurant-img');restaurantImage.className='restaurant-img';restaurantImage.setAttribute('alt','Picture of '+restaurant.name);restaurantImage.src=DBHelper.imageUrlForRestaurant(restaurant);const restaurantCuisine=document.createElement('p');restaurantCuisine.setAttribute('id','restaurant-cuisine');restaurantCuisine.className='restaurant-cuisine';restaurantCuisine.innerHTML=restaurant.cuisine_type;restaurantContainer.append(restaurantHeading);restaurantContainer.append(restaurantImage);restaurantContainer.append(restaurantCuisine);restaurantContainer.append(restaurantAddress);// fill operating hours
